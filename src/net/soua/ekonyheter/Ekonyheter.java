...
import net.soua.ekonyheter.EkoHelper.ApiException;
import net.soua.ekonyheter.EkoHelper.ParseException;
 ...
 */
public class Ekonyheter extends AppWidgetProvider {
    @Override
    ...
    public static class UpdateService extends Service {
        ...
        public void onStart(Intent intent, int startId) {
            ...
            ComponentName thisWidget = new ComponentName(this, Ekonyheter.class);
